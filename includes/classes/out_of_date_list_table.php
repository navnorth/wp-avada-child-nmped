...
class Out_Of_Date_List_Table extends WP_List_Table{
    ...
    */
    ...
    public function no_items() {
        /* -- Get theme setting for how old -- */
        $age = get_option('nmped_age_days');
        _e( '<style>#out_of_content_widget tfoot { display: none; }</style>' );
        _e( '<p>Everything is <i>up-to-date</i>!</p><p>All published pages have been modified within the last '.$age.' days.</p>', 'wp-avada-child-nmped' );
    }
