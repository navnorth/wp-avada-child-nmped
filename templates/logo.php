	...
	<?php if ( ( Avada()->settings->get( 'logo', 'url' ) && '' !== Avada()->settings->get( 'logo', 'url' ) ) || ( Avada()->settings->get( 'logo_retina', 'url' ) && '' !== Avada()->settings->get( 'logo_retina', 'url' ) ) ) : ?>
		<a class="fusion-logo-link" href="<?php echo esc_url_raw( home_url( '/' ) ); ?>">
			...
			<?php if ( Avada()->settings->get( 'logo_retina', 'url' ) && '' !== Avada()->settings->get( 'logo_retina', 'url' ) && '' !== Avada()->settings->get( 'logo_retina', 'width' ) && '' !== Avada()->settings->get( 'logo_retina', 'height' ) ) : ?>
				...
				<img src="<?php echo esc_url_raw( $retina_logo ); ?>" width="<?php echo esc_attr( $logo_size['width'] ); ?>" height="<?php echo esc_attr( $logo_size['height'] ); ?>" alt="" <?php echo $style; // WPCS: XSS ok. ?> class="fusion-standard-logo fusion-logo-2x" />
			<?php else : ?>
				<img src="<?php echo esc_url_raw( $logo_url ); ?>" width="<?php echo esc_attr( $logo_size['width'] ); ?>" height="<?php echo esc_attr( $logo_size['height'] ); ?>" alt="" class="fusion-standard-logo fusion-logo-2x" />
			<?php endif; ?>
			...
			<?php if ( Avada()->settings->get( 'mobile_logo', 'url' ) && '' !== Avada()->settings->get( 'mobile_logo', 'url' ) ) : ?>
				...
				<img src="<?php echo esc_url_raw( $mobile_logo_data['url'] ); ?>" width="<?php echo esc_attr( $mobile_logo_data['width'] ); ?>" height="<?php echo esc_attr( $mobile_logo_data['height'] ); ?>" alt="" class="fusion-logo-1x fusion-mobile-logo-1x" />
				...
				<?php if ( Avada()->settings->get( 'mobile_logo_retina', 'url' ) && '' != Avada()->settings->get( 'mobile_logo_retina', 'url' ) && '' != Avada()->settings->get( 'mobile_logo_retina', 'width' ) && '' != Avada()->settings->get( 'mobile_logo_retina', 'height' ) ) : ?>
					...
					?>
					<img src="<?php echo esc_url_raw( $retina_mobile_logo_data['url'] ); ?>" width="<?php echo esc_attr( $retina_mobile_logo_data['width'] ); ?>" height="<?php echo esc_attr( $retina_mobile_logo_data['height'] ); ?>" alt="" <?php echo $style; // WPCS: XSS ok. ?> class="fusion-logo-2x fusion-mobile-logo-2x" />
				<?php else : ?>
					<img src="<?php echo esc_url_raw( $mobile_logo_data['url'] ); ?>" width="<?php echo esc_attr( $mobile_logo_data['width'] ); ?>" height="<?php echo esc_attr( $mobile_logo_data['height'] ); ?>" alt="" class="fusion-logo-2x fusion-mobile-logo-2x" />
				<?php endif; ?>
			<?php endif; ?>
			...
			<?php if ( Avada()->settings->get( 'sticky_header_logo', 'url' ) && '' !== Avada()->settings->get( 'sticky_header_logo', 'url' ) && ( in_array( Avada()->settings->get( 'header_layout' ), array( 'v1', 'v2', 'v3', 'v6', 'v7' ) ) || ( ( in_array( Avada()->settings->get( 'header_layout' ), array( 'v4', 'v5' ) ) && 'menu_and_logo' === Avada()->settings->get( 'header_sticky_type2_layout' ) ) ) ) ) : ?>
				...
				<img src="<?php echo esc_url_raw( $sticky_logo_data['url'] ); ?>" width="<?php echo esc_attr( $sticky_logo_data['width'] ); ?>" height="<?php echo esc_attr( $sticky_logo_data['height'] ); ?>" alt="" class="fusion-logo-1x fusion-sticky-logo-1x" />
				...
				<?php if ( Avada()->settings->get( 'sticky_header_logo_retina', 'url' ) && '' !== Avada()->settings->get( 'sticky_header_logo_retina', 'url' ) && '' !== Avada()->settings->get( 'sticky_header_logo_retina', 'width' ) && '' !== Avada()->settings->get( 'sticky_header_logo_retina', 'height' ) ) : ?>
					...
					?>
					<img src="<?php echo esc_url_raw( $retina_sticky_logo_data['url'] ); ?>" width="<?php echo esc_attr( $retina_sticky_logo_data['width'] ); ?>" height="<?php echo esc_attr( $retina_sticky_logo_data['height'] ); ?>" alt="" <?php echo $style; // WPCS: XSS ok. ?> class="fusion-logo-2x fusion-sticky-logo-2x" />
				<?php else : ?>
					<img src="<?php echo esc_url_raw( $sticky_logo_data['url'] ); ?>" width="<?php echo esc_attr( $sticky_logo_data['width'] ); ?>" height="<?php echo esc_attr( $sticky_logo_data['height'] ); ?>" alt="" class="fusion-logo-2x fusion-sticky-logo-2x" />
				<?php endif; ?>
			<?php endif; ?>
		</a>
	<?php endif; ?>
